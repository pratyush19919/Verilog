...
set_property PACKAGE_PIN W15 [get_ports {in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {in[0]}]
set_property PACKAGE_PIN V15 [get_ports {in[1]}]					
...
set_property PACKAGE_PIN W13 [get_ports {in[3]}]					
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports load_A]						
	set_property IOSTANDARD LVCMOS33 [get_ports load_A]
set_property PACKAGE_PIN T18 [get_ports load_B]						
